...
**Purpose**: Generate a complete, working single-page web application for creating AWS tagging policies with a visual form builder.
...
- Color scheme: Blues and grays (FinOps/cloud theme)
