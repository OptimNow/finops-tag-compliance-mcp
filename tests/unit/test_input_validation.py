...
class TestValidateResourceTypes:
    ...
    def test_valid_resource_types(self):
        ...
        result = InputValidator.validate_resource_types(["ec2:instance", "s3:bucket"])
    ...
    def test_resource_types_duplicates(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_resource_types(["ec2:instance", "ec2:instance"])
    ...
    def test_resource_types_invalid_type(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_resource_types(["ec2:instance", "invalid:type"])
...
class TestValidateTimePeriod:
    ...
    def test_time_period_invalid_date_format(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_time_period({"Start": "01/01/2024", "End": "2024-01-31"})
    ...
    def test_time_period_end_before_start(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_time_period({"Start": "2024-01-31", "End": "2024-01-01"})
    ...
    def test_time_period_too_large(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_time_period({"Start": "2023-01-01", "End": "2024-12-31"})
...
class TestValidateString:
    ...
    def test_string_with_pattern(self):
        ...
        result = InputValidator.validate_string("123", "test_field", pattern=pattern)
        assert result == "123"

        with pytest.raises(ValidationError) as exc_info:
            InputValidator.validate_string("abc", "test_field", pattern=pattern)
    ...
    def test_string_sanitization(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.validate_string("test\x00injection", "test_field")
...
class TestInjectionDetection:
    ...
    def test_detect_xss_script_tag(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("<script>alert('xss')</script>", "test_field")
    ...
    def test_detect_javascript_protocol(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("javascript:alert('xss')", "test_field")
    ...
    def test_detect_event_handlers(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("<img onerror='alert(1)'>", "test_field")
    ...
    def test_detect_eval_calls(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("eval(malicious_code)", "test_field")
    ...
    def test_detect_template_injection(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("${malicious_code}", "test_field")
    ...
    def test_detect_path_traversal(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("../../etc/passwd", "test_field")
    ...
    def test_detect_system_file_access(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("cat /etc/passwd", "test_field")
    ...
    def test_detect_command_execution(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("cmd.exe /c dir", "test_field")
    ...
    def test_detect_destructive_commands(self):
        ...
        with pytest.raises(SecurityViolationError) as exc_info:
            InputValidator.detect_injection_attempt("; rm -rf /", "test_field")
    ...
    def test_safe_strings_pass(self):
        ...
        InputValidator.detect_injection_attempt(
            "arn:aws:ec2:us-east-1:123456789012:instance/i-123", "test_field"
        )
...
class TestParameterSizeLimits:
    ...
    def test_check_nested_arrays_and_dicts(self):
        ...
        data = {"level1": {"array": ["item1", "item2"], "nested": {"field": "value"}}}
