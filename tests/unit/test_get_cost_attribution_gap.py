...
async def test_get_cost_attribution_gap_basic(mock_aws_client, mock_policy_service):
    ...
    mock_aws_client.get_service_name_for_resource_type = MagicMock(
        return_value="Amazon Elastic Compute Cloud - Compute"
    )
...
@pytest.mark.asyncio
async def test_get_cost_attribution_gap_with_custom_time_period(
...
@pytest.mark.asyncio
async def test_get_cost_attribution_gap_group_by_resource_type(
    mock_aws_client, mock_policy_service
):
...
@pytest.mark.asyncio
async def test_get_cost_attribution_gap_multiple_resource_types(
    mock_aws_client, mock_policy_service
):
...
async def test_get_cost_attribution_gap_handles_fetch_errors(
