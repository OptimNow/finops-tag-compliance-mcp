...
class TestResourceMetadataCompleteness:
    ...
    async def test_untagged_resource_has_all_required_fields(
        ...
        f"get_{resource_type.replace(':', '_').replace('instance', 'instances').replace('db', 'instances').replace('bucket', 'buckets').replace('function', 'functions').replace('service', 'services')}"
