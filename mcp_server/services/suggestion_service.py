...
class SuggestionService:
    ...
    ENVIRONMENT_PATTERNS = {
        "production": [r"prod", r"prd", r"production", r"live", r"main"],
        "staging": [r"stag", r"stg", r"staging", r"preprod", r"pre-prod", r"uat"],
        "development": [r"dev", r"develop", r"development", r"sandbox"],
        "test": [r"test", r"tst", r"qa", r"quality"],
    }
    ...
    COST_CENTER_PATTERNS = {
        ...
        "Marketing": [r"mkt", r"marketing", r"campaign", r"analytics", r"growth"],
        "Sales": [r"sales", r"crm", r"revenue", r"commercial"],
        "Operations": [r"ops", r"operations", r"support", r"helpdesk", r"service"],
        "Finance": [r"fin", r"finance", r"billing", r"accounting", r"payment"],
    }

    # Data classification patterns
    DATA_CLASSIFICATION_PATTERNS = {
        "public": [r"public", r"cdn", r"static", r"assets", r"media"],
        "internal": [r"internal", r"private", r"corp", r"intranet"],
        "confidential": [r"confidential", r"sensitive", r"pii", r"customer"],
        "restricted": [r"restricted", r"secret", r"classified", r"hipaa", r"pci"],
    }
    ...
    async def _suggest_tag_value(
        ...
        pattern_suggestion = self._suggest_from_patterns(
            tag_name=tag_name, allowed_values=allowed_values, context=context
        )
        ...
        for env_value, patterns in self.ENVIRONMENT_PATTERNS.items():
            for pattern in patterns:
                if re.search(pattern, combined_context, re.IGNORECASE):
                    ...
                    confidence, source = self._calculate_pattern_confidence(pattern, context)
