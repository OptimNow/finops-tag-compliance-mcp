...
class ResourceTypeConfig:
    ...
    def _load_config(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Resource type config not found at {self.config_path}, using defaults")
    ...
    def _get_default_config(self) -> dict:
        ...
        return {
            ...
            "unattributable_services": {
                "ai_ml_api_usage": ["Claude 3.5 Sonnet (Amazon Bedrock Edition)", "Amazon Bedrock"],
